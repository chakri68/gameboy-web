...
function romListItem(rom: Rom): string {
  ...
  if (rom.demo) links.push(`<a href="${escapeHtml(rom.demo)}" rel="noopener">demo</a>`);
  return (
...
export function htmlInject(): Plugin {
  return {
    ...
    transformIndexHtml: {
      order: "pre",
      handler() {
        const file = resolve(process.cwd(), "public/content.json");
        ...
        return {
          ...
          tags: [
            ...
            { tag: "meta", attrs: { name: "description", content: SITE_DESC }, injectTo: "head" },
            // Open Graph
            ...
            { tag: "meta", attrs: { property: "og:description", content: SITE_DESC }, injectTo: "head" },
            ...
            { tag: "meta", attrs: { name: "twitter:description", content: SITE_DESC }, injectTo: "head" },
            { tag: "meta", attrs: { name: "twitter:image", content: OG_IMAGE }, injectTo: "head" },
            // preconnect to the Pages host serving most embeds
            { tag: "link", attrs: { rel: "preconnect", href: "https://chakri68.github.io" }, injectTo: "head" },
            // Crawlable / pre-JS accessible list
            { tag: "div", attrs: { id: "rom-fallback-wrap" }, children: listHtml, injectTo: "body-prepend" },
          ],
        };
      },
    },
